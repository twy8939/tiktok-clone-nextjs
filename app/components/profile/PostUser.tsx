  ...
  return (
    <>
      <div className="relative brightness-90 hover:brightness-[1.1] cursor-pointer">
        {!post.video_url ? (
          <div className="absolute items-center justify-center top-0 left-0 aspect-[3/4] w-full object-cover rounded-md bg-black">
        ...
        <div className="px-1">
          <p className="text-gary-700 text-[15px] pt-1 break-words">
            {post.text}
          </p>
